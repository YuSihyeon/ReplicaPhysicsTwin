...
- 프로젝트 경로: `C:\URLabWorkspace\ReplicaPhysicsTwin`
...
- `C:\URLabWorkspace\RobotLLM`은 읽기 전용 참조 대상으로 보호한다.
...
| 대상 | 확인 결과 | 비고 |
|---|---|---|
| 기존 프로젝트 | 존재 | `C:\URLabWorkspace\RobotLLM` |
| 신규 프로젝트 | 존재 | `C:\URLabWorkspace\ReplicaPhysicsTwin` |
...
확인 경로: `C:\URLabWorkspace\ReplicaPhysicsTwin\data`
